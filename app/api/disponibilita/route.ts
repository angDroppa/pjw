...
import {
  DisponibilitaQuerySchema,
  DisponibilitaResponse,
} from "@/lib/validators/biciclettaLocation";
...
export async function GET(req: NextRequest) {
  ...
  for (const stock of stocks) {
    ...
    result.push({
      ...
      biciclettaSpecific: {
        ...
        prezzoMezzaGiornata:
          stock.biciclettaSpecific.prezzoMezzaGiornata.toNumber(),
        altezzaMin: stock.biciclettaSpecific.altezzaMin ?? undefined,
        altezzaMax: stock.biciclettaSpecific.altezzaMax ?? undefined,

        bicicletta: {
          id: stock.biciclettaSpecific.bicicletta.id,
          nome: stock.biciclettaSpecific.bicicletta.nome,
          tipologia: stock.biciclettaSpecific.bicicletta.tipologia,
        },
      },
  ...
  return NextResponse.json<{ disponibilita: DisponibilitaResponse[] }>({
