...
export default function StepDate({ onNext, onPrev }: { onNext: () => void; onPrev: () => void }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <p className="app-text-muted text-sm">Scegli quando vuoi ritirare e riconsegnare la bici.</p>

      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-2">
          <label className="app-label">Ritiro</label>
          <input
            type="date"
            value={dataRitiro}
        ...
        <div className="flex flex-col gap-2">
          <label className="app-label">Riconsegna</label>
          <input
            type="date"
            value={dataConsegna}
